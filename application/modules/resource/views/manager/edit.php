                                    ...
                                    <div class="col-sm-6">
                                      ...
                                      <div class="checkbox my-checkbox">
                                        ...
                                        <?php else : ?>
                                          <input type="checkbox" name="published" checked="checked" value="1" class="icheck"> Published </label>
                                        <?php endif ?>
                                        <label class="checkbox-inline" style="margin-left:0px" data-toggle="tooltip" title="Chọn để thêm vào Banner Gallery"> 
                                        ...
                                        <label class="checkbox-inline" data-toggle="tooltip" title="Chọn để thêm vào Slider"> 
                                          <input type="checkbox" name="is_hot" value="1" <?php if(@$resource->is_hot == 1) echo "checked=checked";?> class="icheck"> is Hot News 
                                        </label>
