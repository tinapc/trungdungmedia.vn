...
<ul class="nav nav-pills">
	...
	<li class="dropdown">
		<a class="dropdown-toggle disabled <?=$activeWhyChooseTD?>" data-toggle="dropdown" role="button" aria-expanded="false" href="<?=site_url('page/ly-do-chon-tam-diem')?>" title="">Lý do chọn Tâm Điểm</a>
	</li>
	<li class="dropdown">
